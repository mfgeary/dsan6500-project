...
print("Using VGG11 model on {}.".format(device))
# Define the model
...
torch.save(metrics_list, "metrics_list_vgg11_0001.pt")
...
df.to_csv("losses_accuracies_vgg11_0001.csv", index=False)

# evaluate on test set
model.load_state_dict(torch.load('best_model.pt'))
# Resave best model
torch.save(model.state_dict(), 'best_model_vgg11_0001.pt')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('vgg11_loss_0001.png')
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('vgg11_val_accuracy_0001.png')
plt.show()